...
class ClassWithComplexInitialization {
    int value = 0; // this is executed firstly during initialization

    {
        System.out.println("value initialized to : " + value);
        System.out.println("Entering first initialization block!");
        value = value + 3; // this initialization block is run for second
        System.out.println("value: " + value);
        System.out.println("Exiting first initialization block!");
    }

    // constructor code is executed only at the end
    ...
    int secondValue = 5; // then its the turn of this statement, for third



    // this block is run afterwards, right before the constructor
    {
